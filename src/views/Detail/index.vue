      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            <h3 class="InfoName">{{goods.skuInfo.skuName}}</h3>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in goods.spuSaleAttrList" :key="item.id">
                <dt class="title">{{item.saleAttrName}}</dt>
                <dd changepirce="0" v-for="item1 in item.spuSaleAttrValueList" :key="item1.id" class="active">{{item1.saleAttrValueName}}</dd>
